...
public class SetTransactionTest extends BaseTestCase {
    ...
    public void getChangeMetaData() {
        ...
        assertEquals(ChangeMetaData.PRIORITY_DEFAULT, Scope.getCurrentScope().getSingleton(ChangeFactory.class).getChangeMetaData(setTransactionChange).getPriority());
    }
