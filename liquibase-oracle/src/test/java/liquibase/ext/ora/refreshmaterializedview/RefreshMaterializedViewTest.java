...
public class RefreshMaterializedViewTest extends BaseTestCase {
    ...
    public void getChangeMetaData() {
        ...
        assertEquals("metadata priority incorrect", ChangeMetaData.PRIORITY_DEFAULT, Scope.getCurrentScope().getSingleton(ChangeFactory.class).getChangeMetaData(change).getPriority());
    }
