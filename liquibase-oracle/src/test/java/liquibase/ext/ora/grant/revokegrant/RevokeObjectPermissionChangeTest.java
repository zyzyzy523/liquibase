...
public class RevokeObjectPermissionChangeTest extends BaseTestCase {
    ...
    public void getChangeMetaData() {
        ...
        assertEquals("revokeObjectPermission", changeFactory.getChangeMetaData(change).getName());
        assertEquals("Revoke Schema Object Permission", changeFactory.getChangeMetaData(change).getDescription());
