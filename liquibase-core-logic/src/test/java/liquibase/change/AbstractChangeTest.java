...
public class AbstractChangeTest {
  ...
  public static void unClench() {
    ...
    public void warn_unsupportedButSkip() throws Exception {
        Database database = DatabaseFactory.getInstance().findByName("mysql");
    ...
    public void validate_missingRequiredValue() throws Exception {
        ExampleAbstractChange change = new ExampleAbstractChange();
        ValidationErrors errors = change.validate(DatabaseFactory.getInstance().findByName("mssql"));
    ...
    public void generateCheckSum() {
        ExampleAbstractChange change = new ExampleAbstractChange();
        String serializedChange = ChangeLogSerializerFactory.getInstance().getSerializer("checksum").serialize(change, false);
