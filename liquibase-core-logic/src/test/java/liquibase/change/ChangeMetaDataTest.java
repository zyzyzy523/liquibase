...
public class ChangeMetaDataTest {
    ...
    public void getRequiredParameters() {
        ...
        assertSetsEqual(new String[]{"allRequired"}, changeMetaData.getRequiredParameters(DatabaseFactory.getInstance().findByName("mysql")).keySet());
    }
    ...
    public void getOptionalParameters() {
        ...
        assertSetsEqual(new String[]{"noneRequired", "h2Required", "oracleRequired"}, changeMetaData.getOptionalParameters(DatabaseFactory.getInstance().findByName("mysql")).keySet());
    }
