...
//
//        Element node = new XmlUnparser(DocumentBuilderFactory.newInstance().newDocumentBuilder().newDocument()).createNode(change);
//
...
//
//        Element node = new XmlUnparser(DocumentBuilderFactory.newInstance().newDocumentBuilder().newDocument()).createNode(refactoring);
...
//
//        Element element = new XmlUnparser(DocumentBuilderFactory.newInstance().newDocumentBuilder().newDocument()).createNode(column);
...
//
//        Element element = new XmlUnparser(DocumentBuilderFactory.newInstance().newDocumentBuilder().newDocument()).createNode(refactoring);
...
//
//        node = new XmlUnparser(DocumentBuilderFactory.newInstance().newDocumentBuilder().newDocument()).createNode(change);
//        assertEquals("createSequence", node.getNodeName());
//        assertEquals("SEQ_NAME", node.getAttribute("sequenceName"));
//        assertEquals("1", node.getAttribute("incrementBy"));
//        assertEquals("2", node.getAttribute("maxValue"));
...
//
//        Element element = new XmlUnparser(DocumentBuilderFactory.newInstance().newDocumentBuilder().newDocument()).createNode(change);
...
//
//        String out = new XmlUnparser().serialize(change, true);
