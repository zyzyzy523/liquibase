 ...
 */
public class ChangeSet extends AbstractExtensibleObject implements ChangeLogEntry, Conditional {
    ...
    public ChangeSet(ChangeLog changeLog) {
        this.changes = new ArrayList<>();
        this.changeLog = changeLog;
    }

    public ChangeSet(String id, String author, boolean alwaysRun, boolean runOnChange, String filePath, String contextList, String dbmsList, ChangeLog changeLog) {
        this(id, author, alwaysRun, runOnChange, filePath, contextList, dbmsList, true, ObjectQuotingStrategy.LEGACY, changeLog);
    }

    public ChangeSet(String id, String author, boolean alwaysRun, boolean runOnChange, String filePath, String contextList, String dbmsList, boolean runInTransaction, ChangeLog changeLog) {
        this(id, author, alwaysRun, runOnChange, filePath, contextList, dbmsList, runInTransaction, ObjectQuotingStrategy.LEGACY, changeLog);
    }

    public ChangeSet(String id, String author, boolean alwaysRun, boolean runOnChange, String filePath, String contextList, String dbmsList, ObjectQuotingStrategy quotingStrategy, ChangeLog changeLog) {
        this(id, author, alwaysRun, runOnChange, filePath, contextList, dbmsList, true, quotingStrategy, changeLog);
    }
    ...
    public ChangeSet(String id, String author, boolean alwaysRun, boolean runOnChange, String filePath, String contextList, String dbmsList,
                     boolean runInTransaction, ObjectQuotingStrategy quotingStrategy, ChangeLog changeLog) {
        this(changeLog);
        this.id = id;
        this.author = author;
...
////        if (changeLog != null) {
////            this.objectQuotingStrategy = changeLog.objectQuotingStrategy;
////        }
...
//                changeLog = changeLog.getContainerChangeLog();
//                if (changeLog != null) {
...
//    }
    ...
    public ExecType execute(ChangeLog changeLog, Database database) throws MigrationFailedException {
     ...
     */
    public ExecType execute(ChangeLog changeLog, ChangeExecListener listener, Database database)
        ...
        try {
            ...
            try {
                if (preconditions != null) {
                    preconditions.check(database, changeLog, this, listener);
                }
            ...
            if (!skipChange) {
                ...
                for (Change change : getChanges()) {
                    if ((!(change instanceof DbmsTargetedChange)) || DatabaseList.definitionMatches(((DbmsTargetedChange) change).getDbms(), database, true)) {
                        ...
                        database.executeStatements(change, changeLog, sqlVisitors);
