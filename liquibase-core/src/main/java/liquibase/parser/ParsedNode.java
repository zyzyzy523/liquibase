...
public class ParsedNode extends AbstractExtensibleObject {
    ...
    public ParsedNode rename(String newName) {
        Scope.getCurrentScope().getLog(getClass()).fine("Renamed '" + this.name + "' to '" + newName + "'");
        this.name = newName;
        return this;
    }
    ...
    public ParsedNode setValue(Object value) {
        Scope.getCurrentScope().getLog(getClass()).fine("Setting '" + this.name + "' value '" + value + "'");
    ...
    public void moveValue(ParsedNode newNode) {
        Scope.getCurrentScope().getLog(getClass()).fine("Moving node value from '" + this.name + "' to '" + newNode.name + "'");
    ...
    public void remove() throws ParseException {
        ...
        Scope.getCurrentScope().getLog(getClass()).fine("Removing '" + this.name + "' from '" + parent.name + "'");
    ...
    public void moveChildren(ParsedNodeFilter filter, ParsedNode newParent) {
        ...
        while (childIterator.hasNext()) {
            ParsedNode child = childIterator.next();
            if (filter.matches(child)) {
                Scope.getCurrentScope().getLog(getClass()).fine("Moving '" + child.name + "' from '" + child.parent.name + "' to '" + newParent.name + "'");
    ...
    public void moveTo(ParsedNode newParent) {
        Scope.getCurrentScope().getLog(getClass()).fine("Moving '" + this.name + "' from '" + this.parent.name + "' to '" + newParent.name + "'");
    ...
    public ParsedNode copyTo(ParsedNode newParent) {
        Scope.getCurrentScope().getLog(getClass()).fine("Copying '" + this.name + "' from '" + this.parent.name + "' to '" + newParent.name + "'");
    ...
    public void renameChildren(ParsedNodeFilter filter, String newName) {
        for (ParsedNode child : children) {
            if (filter.matches(child)) {
                Scope.getCurrentScope().getLog(getClass()).fine("Renamed '" + child.name + "' to '" + newName + "'");
                child.name = newName;
            }
        }
