...
public interface ParsedNodeMapping<ObjectType> extends Plugin {
     ...
     * @param objectType the type of the object to create via {@link #toObject(ParsedNode, Class, Class, String)} and/or to parse via {@link #toParsedNode(Object, Class, String, ParsedNode)}
     ...
     */
    int getPriority(ParsedNode parsedNode, Class objectType, Type containerType, String containerAttribute);

    /**
     * Converts the given objectToConvert into a parsed node. Using the containerType and/or containerAttribute as needed.
     */
    ParsedNode toParsedNode(ObjectType objectToConvert, Class containerType, String containerAttribute, ParsedNode parentNode) throws ParseException;
     ...
     */
    ObjectType toObject(ParsedNode parsedNode, Class<ObjectType> objectType, Class containerType, String containerAttribute) throws ParseException;
}
