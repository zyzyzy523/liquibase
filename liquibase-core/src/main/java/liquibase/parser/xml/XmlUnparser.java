...
public class XmlUnparser extends AbstractUnparser {
    ...
    protected void writeNode(ParsedNode node, XMLStreamWriter writer, int depth) throws XMLStreamException, ParseException {
        ...
        writer.writeCharacters(Scope.getCurrentScope().getLineSeparator());
