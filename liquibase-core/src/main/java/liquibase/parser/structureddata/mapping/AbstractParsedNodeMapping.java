...
public abstract class AbstractParsedNodeMapping<ObjectType extends ExtensibleObject> implements ParsedNodeMapping<ObjectType> {
    ...
    /**
     * Default implementation uses {@link #getNodeName(ExtensibleObject, Class, String)} for the returned ParsedNode's name,
     ...
     */
    @Override
    public ParsedNode toParsedNode(ObjectType objectToConvert, Class containerType, String containerAttribute, ParsedNode parentNode) throws ParseException {
        ParsedNode node;
        String nodeName = containerAttribute;
        if (nodeName == null) {
            nodeName = getNodeName(objectToConvert, containerType, containerAttribute);
        }
        if (parentNode == null) {
    ...
    public ObjectType toObject(ParsedNode parsedNode, Class<ObjectType> objectType, Class containerType, String containerAttribute) throws ParseException {
        ObjectType returnObject = createObject(parsedNode, objectType, containerType, containerAttribute);
    ...
    protected String getNodeName(ObjectType object, Class containerType, String containerAttribute) {
        if (object == null) {
            return "null";
        }
     ...
     */
    protected ObjectType createObject(ParsedNode parsedNode, Class<ObjectType> objectType, Class containerType, String containerAttribute) throws ParseException {
        try {
