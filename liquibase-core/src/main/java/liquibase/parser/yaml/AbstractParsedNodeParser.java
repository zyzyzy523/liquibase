 ...
 */
public abstract class AbstractParsedNodeParser extends AbstractParser {
    ...
    /**
     * Converts the file at sourcePath to the passed objectType using the configured {@link ParsedNodePreprocessor}(s), {@link liquibase.parser.mapping.ParsedNodeMapping} and {@link liquibase.parser.postprocessor.MappingPostprocessor}(s).
