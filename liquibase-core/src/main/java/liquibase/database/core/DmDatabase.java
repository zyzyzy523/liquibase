...
public class DmDatabase extends AbstractJdbcDatabase {
    ...
    public String getJdbcSchemaName(CatalogAndSchema schema) {
        return correctObjectName((schema.getCatalogName() ==
                null) ? schema.getSchemaName() : schema.getCatalogName(), Schema.class);
    }
    ...
    protected String getConnectionCatalogName() {
        try {
            //noinspection HardCodedStringLiteral
            return ExecutorService.getInstance().getExecutor(this).queryForObject(new RawCallStatement("select " +
                    "sys_context( 'userenv', 'current_schema' ) from dual"), String.class);
        } catch (Exception e) {
            //noinspection HardCodedStringLiteral
